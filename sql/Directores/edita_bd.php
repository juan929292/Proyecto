...
echo "</br><h3>Editar Director:</h3></br>";
		?>
        ...
        <?php
            while($obj=$result->fetch_object()){
                ...
                echo "<td>$obj->pais</td>";
                echo "<td><a href='edita_bd.php?idd=$obj->id_director'><img width=26 src='../../img/edita.png'/></a></td>";
                echo "</tr>";   
            }
        ?>
        </table></br>
	...
	echo "</br><a href='../../../Proyecto/administracion_bd.php'>"."<input type='button' value='Volver a panel administración' style='font-family: Verdana; font-size: 10 pt'></br></a>";
        ...
        $result=$connection->query("SELECT * FROM directores where id_director=".$_GET['idd'].";");
							...
							while($obj=$result->fetch_object()){
								echo "</br><h3>Editar Director: ".$obj->nombre ."</h3>";
								echo "<input required type='hidden' value=".$obj->id_director ." name='val1' readonly='readonly'>"."</br>";
								echo "<h3>Nombre:</h3></br>";
								echo "<input required type='text' placeholder="."'".$obj->nombre ."'"." name='val2'>"."</br></br>";
								echo "<h3>Pais:</h3></br>";
